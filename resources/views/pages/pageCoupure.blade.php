...
@section('main')
    <div class="menu-coupure">
        ...
        <div class="title-coupure">
            ...
            <h2 class="title">{{ $feeder->designation }}</h2>
        </div>
        <div class="content">
            <div class="m-p m-coupure">
                <div class="content-program heure title-etat">
                    <p style="font-size: 20px">Etat Actuel du feeder <br>
                    </p>
                </div>
                ...
                <div class="action action-h action-coupure">
                    <a href="{{ route('coupure.edit',$feeder->id) }}" class="btn-coupure" style="background-color: gray">OFF</a>
                </div>
                @else
                <div class="action action-h action-coupure">
                    <a href="{{ route('coupure.edit',$feeder->id) }}" class="btn-coupure">ON</a>
                </div>
                @endif
            </div>
        </div>
