...
@section('main')
    <div class="add-agent">
        <div class="head add-agent-head" style="display: flex;justify-content: space-between;align-items: center">
            <a class="retour" href="{{ route('user.index') }}" style="width: 10%;">
            ...
            <p class="title">ajouter un agent</p>
        </div>
        <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="group-form" style="width: 100%">
                <label for="confirm">choose file</label>
                <input type="file" class="input-form" id="confirm" name="file" placeholder="confirmer votre mot de passe">
            </div>
