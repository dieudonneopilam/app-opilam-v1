...
@section('main')
    <div class="menu-main">
        ...
        <div class="content">
            <a href="{{ route('agents') }}" class="menu">
            ...
            <a href="{{ route('feeders') }}" class="menu">
            ...
            <a href="{{ route('program') }}" class="menu">
            ...
            <a href="{{ route('coupure') }}" class="menu">
                ...
                <span class="gestion">Coupure</span>
            </a>
        </div>
    </div>
@endsection
