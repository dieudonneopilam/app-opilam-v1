  ...
  */
  ...
  <body id="t" style="font-family: system-ui, sans-serif; font-size: 75%" jstcache="0" class="neterror">
    <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
      <div id="main-content" jstcache="0">
        ...
        <div id="main-message" jstcache="0">
          <h1 jstcache="0">
            <span jsselect="heading" jsvalues=".innerHTML:msg" jstcache="14">Désolé, impossible d’accéder à cette page.</span>
            <a id="error-information-button" class="hidden" onclick="toggleErrorInformationPopup();" jstcache="0"></a>
          </h1>
          <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="3">Il semblerait que la page web à l'adresse <strong jscontent="failedUrl" jstcache="27">https://ntp.msn.com/edge/ntp?locale=fr&amp;title=Nouvel%20onglet&amp;dsp=1&amp;sp=Bing&amp;invalidaterender=1</strong> rencontre peut-être des problèmes ou a été définitivement déplacée vers une nouvelle adresse web.</p>
            ...
            <div id="error-information-popup" jstcache="0">
              <div id="error-information-popup-box" jstcache="0">
                <div id="error-information-popup-content" jstcache="0">
                  ...
                  <div class="error-code" jscontent="errorCode" jstcache="22">ERR_FAILED</div>
    ...
    <div id="sub-frame-error" jstcache="0">
      ...
      <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="3">Il semblerait que la page web à l'adresse <strong jscontent="failedUrl" jstcache="27">https://ntp.msn.com/edge/ntp?locale=fr&amp;title=Nouvel%20onglet&amp;dsp=1&amp;sp=Bing&amp;invalidaterender=1</strong> rencontre peut-être des problèmes ou a été définitivement déplacée vers une nouvelle adresse web.</div>
    </div>
  ...
  </script><script jstcache="0">const pageData = {"details":"Détails","errorCode":"ERR_FAILED","fontfamily":"system-ui, sans-serif","fontsize":"75%","heading":{"hostName":"ntp.msn.com","msg":"Désolé, impossible d’accéder à cette page."},"hideDetails":"Masquer les détails","iconClass":"icon-thinking","is_windows_xbox_sku":"false","language":"fr","suggestionsDetails":[],"suggestionsSummaryList":[],"summary":{"failedUrl":"https://ntp.msn.com/edge/ntp?locale=fr&title=Nouvel%20onglet&dsp=1&sp=Bing&invalidaterender=1","hostName":"ntp.msn.com","msg":"Il semblerait que la page web à l'adresse \u003Cstrong jscontent=\"failedUrl\">\u003C/strong> rencontre peut-être des problèmes ou a été définitivement déplacée vers une nouvelle adresse web."},"textdirection":"ltr","title":"ntp.msn.com"};loadTimeData.data = pageData;var tp = document.getElementById('t');jstProcess(new JsEvalContext(pageData), tp);</script></body></html>
